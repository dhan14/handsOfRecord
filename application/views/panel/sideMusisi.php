    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url('dashboard-musisi')?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('dashboard-musisi/submission')?>">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Submission</span></a>
            </li>
            <li class="nav-item">
                <?php foreach ($valArtist as $key) :?>
                <?php    $alamat = base_url('dashboard-musisi/bandProfile/'.$key->a_kodeProfil);?>
                <a class="nav-link" href="<?php echo $alamat?>">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Profile</span></a><?php endforeach;?>
            </li>
            <!-- Divider -->
